...
public class ParaglidingFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ArrayList<Info> arrayList = new ArrayList();
        arrayList.add(new Info(
                getContext().getString(R.string.paragliding_name),
                getContext().getString(R.string.paragliding_description),
                R.drawable.paragliding_image
        ));
